...
{
    public class ShipInitializationCommand : Command
    {
        public const short ID = 26642;

        public static byte[] write(int userId, string userName, int shipType, int speed, int shield, int shieldMax, int hitPoints, int hitMax,
